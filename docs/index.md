...
| `docs/specs/opencli-session-discovery.md` | OpenCLI Session Discovery、Conversation identity、投递验证与 exact-ID recovery 的产品 Contract | 设计、实现或验证 Browser/OpenCLI Session identity 时 | Candidate | 2026-08-11 |
