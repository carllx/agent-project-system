...
| `docs/references/real-agent-review-loop-mvp-001-diagnostic-batch-001.md` | 当前 bounded Diagnostic Batch 的 self-contained Execution Contract | 启动或审计当前 Diagnostic Batch 时 | Ready / Not started | 2026-08-11 |
