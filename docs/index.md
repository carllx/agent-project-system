...
| `docs/references/real-agent-review-loop-mvp-001-acceptance-manual.md` | Manual Relay fallback Acceptance Contract 与当前 ingest blocker | 设计、修复或审计 Manual Relay Acceptance Run 时 | Blocked / Needs ingest adapter | 2026-08-11 |
